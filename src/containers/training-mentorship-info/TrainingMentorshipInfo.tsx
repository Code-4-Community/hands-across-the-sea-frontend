...
const LibraryInfo: React.FC = () => {
    ...
    const [teachersSeekingSupport, setTeacherSeekingSupport] = useState<boolean>(false);
                    ...
                    <Col flex={24}>
                        <FormPiece note="Is there a student librarian program?">
                            <Form.Item name="isThereStudentLibraryProgram">
                                <Radio.Group buttonStyle="solid" onChange={handleChangeStudentLibrarians}>
                                    <Radio.Button value="yes">Yes</Radio.Button>
                                    <Radio.Button value="no">No</Radio.Button>
                                </Radio.Group>
                            </Form.Item>
                            {isStudentLibrary === 'yes' && (<div>
                    ...
                    <Col flex={24}>
                        <FormPiece note="Are the teachers seeking support?">
                            <Form.Item name="areTeachersSeekingSupport">
                                <Radio.Group buttonStyle="solid" onChange={handleChangeTeacherSupport}>
                                    <Radio.Button value="yes">Yes</Radio.Button>
                                    <Radio.Button value="no">No</Radio.Button>
                                </Radio.Group>
                            </Form.Item>
                            {teachersSeekingSupport && <div>
                    ...
                    <Col flex={24}>
                        <FormPiece note="Has the school involved the students parents in the use of the library?">
                            <Form.Item name="hasSchoolInvolvedParentsInLibraryUse">
                                <Radio.Group buttonStyle="solid" onChange={handleChangeInvolvedParents}>
                                    <Radio.Button value="yes">Yes</Radio.Button>
                                    <Radio.Button value="no">No</Radio.Button>
                                </Radio.Group>
                            </Form.Item>
