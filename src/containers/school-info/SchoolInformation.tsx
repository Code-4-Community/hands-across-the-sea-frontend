...
const SchoolInformation: React.FC = () => {
  ...
  const addExtraContact = () => {
    ...
    setExtraContacts(
      extraContacts.concat(
        <AddContact onDelete={removeExtraContact} index={ii} />,
      ),
    );
  };
      ...
      <Row gutter={[0, 24]}>
        <Col flex={24}>
          <FormPiece note="Principal or Director Contact Information">
            ...
            <ClarifyText>
              Is this person a primary or secondary contact?
            </ClarifyText>
        ...
        <Col flex={24}>
          <PointerChange>
            <AddContactContainer addPaddingTop={-20} onClick={addExtraContact}>
              <Row>
                <Col flex={12}>
                  <ClarifyText>Any Additional Contacts to Add?</ClarifyText>
                </Col>
                <Col flex={12}>
                  <MakeRight>
                    <PlusCircleOutlined />
