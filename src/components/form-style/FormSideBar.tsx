...
const FormSideBar: React.FC<FormSideBarProps> = (props) => {
  ...
  const studentBookInfoClass =
    page === '/student-book-information' ? 'currPage' : '';
  const libraryInfoClass = page === '/library-info' ? 'currPage' : '';
  const monitoringInfoClass =
    page === '/monitoring-information' ? 'currPage' : '';
  const trainingMentorClass =
    page === '/training-and-mentoring-information' ? 'currPage' : '';
